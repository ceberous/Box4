...
function INITIALIZE() {
	return new Promise( async function( resolve , reject ) {
		try {
			...
			// ========================================================================================
			// ========================================================================================
			var stopCommand = discordBot.registerCommand( "stop" , Commands.stop.fn , Commands.stop.config );
			discordBot.registerCommandAlias( "quit" , "stop" );

			var pauseCommand = discordBot.registerCommand( "pause" , Commands.pause.fn , Commands.pause.config );
